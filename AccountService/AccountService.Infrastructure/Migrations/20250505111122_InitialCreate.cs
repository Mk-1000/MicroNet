        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SecurityEvents_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Accounts",
                columns: new[] { "Id", "CreatedAt", "Email", "FullName", "GoogleId", "LastLoginAt", "Phone", "Type", "UpdatedAt" },
                values: new object[] { 1, new DateTime(2025, 5, 5, 11, 11, 22, 124, DateTimeKind.Utc).AddTicks(2579), "admin@example.com", "System Administrator", null, new DateTime(2025, 5, 5, 11, 11, 22, 124, DateTimeKind.Utc).AddTicks(2578), "1234567890", 0, new DateTime(2025, 5, 5, 11, 11, 22, 124, DateTimeKind.Utc).AddTicks(2580) });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SecurityEvents_AccountId",
